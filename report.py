...
class reportClass:
    def __init__(self,root):
        ...
        txt_search=Entry(self.root,textvariable=self.var_search,font=("goudy old style",15),bg='lightyellow').place(x=520,y=100,width=180)


        btn_search = Button(self.root, text="Search", font=("goudy old style", 15, "bold"),bg="#03A9F4", fg="white", cursor="hand2",command=self.search).place(x=720, y=98, width=100, height=35)
        btn_clear = Button(self.root, text="Clear", font=("goudy old style", 15, "bold"),bg="green", fg="white", cursor="hand2",command=self.clear).place(x=830, y=98, width=100, height=35)
