...
class studentClass:
    def __init__(self,root):
        ...
        #======title======
        title=Label(self.root,text="Manage Stdent Details",font=("goudy old style",20,"bold"),bg="#033054",fg="white").place(x=10,y=15,width=1180,height=40)
        #=======variables====
        ...
        lbl_ghender=Label(self.root,text="Gender",font=("goudy old style",15,"bold"),bg='white').place(x=10,y=180)
        ...
        txt_city=Entry(self.root,textvariable=self.var_city,font=("goudy old style",15,"bold"),bg='lightyellow').place(x=370,y=220,width=140)

        lbl_pin=Label(self.root,text="Pin",font=("goudy old style",15,"bold"),bg='white').place(x=530,y=220)
        txt_pin=Entry(self.root,textvariable=self.var_pin,font=("goudy old style",15,"bold"),bg='lightyellow').place(x=580,y=220,width=110)
        ...
        #=========Entry Fields of column 2 =====
        self.course_list=["Select","B.Tech", "BCA", "MCA", "B.Sc", "M.Sc"]
        ...
        txt_admission=Entry(self.root,textvariable=self.var_a_date,font=("goudy old style",15,"bold"),bg='lightyellow').place(x=460,y=140,width=200)
...
#=============================data function====================================================================
    ...
    def get_data(self,ev):
        try:
            ...
            if row and len(row) >= 12:
                ...
                print("⚠️ Warning: Empty or invalid row clicked:", row)
        except Exception as ex:
            messagebox.showerror("Error", f"Error due to {str(ex)}", parent=self.root)
   ...
   #=========add function========
    ...
    def add(self):
        ...
        try:
            if self.var_roll.get()=="":
                ...
                row=cur.fetchone()
                if row!=None:
                     messagebox.showerror("Error","Roll No. should be exists",parent=self.root)
                else:
    ...
    def search(self):
        ...
        try:
            # 
            search_text = self.var_search.get()   # <-- हे बरोबर आहे, वर define केलेले पाहिजे
        
            if search_text == "":
                 messagebox.showerror("Error", "Please enter course name to search", parent=self.root)
            #=====chatgpt
            else:
                ...
                if len(rows) != 0:
                    ...
                    messagebox.showinfo("Not Found","No record found",parent=self.root)
