...
class RMS:
    def __init__(self,root):
        ...
        #=====icons======
        self.pic3_dash=ImageTk.PhotoImage(file="images/pic3.png")


        #======title======
        title=Label(self.root,text="College Result Management System",padx=10,compound=LEFT,image=self.pic3_dash,font=("goudy old style",20,"bold"),bg="#033054",fg="white").place(x=0,y=0,relwidth=1,height=50)
        #======Menu=======
        ...
        #=======content_window  
        self.pic2_img=Image.open("images/pic2.png")
        self.pic2_img=self.pic2_img.resize((920,350),Image.LANCZOS)
        self.pic2_img=ImageTk.PhotoImage(self.pic2_img)
        ...
        self.lbl_pic2 = Label(self.root, image=self.pic2_img)
        self.lbl_pic2.place(x=360, y=180, width=920, height=350)  #  इथे x वाढ  जोपर्यंत पटत नाही


        #====Update_details===
        self.lbl_course=Label(self.root,text="Total Course\n[ 0 ]",font=("goudy old style",20),padx=10,pady=10,relief=RIDGE,bg="#e43b06",fg="white")
        self.lbl_course.place(x=400,y=530,width=300,height=100)

        self.lbl_student=Label(self.root,text="Total Course\n[ 0 ]",font=("goudy old style",20),padx=10,pady=10,relief=RIDGE,bg="#0676ad",fg="white")
        self.lbl_student.place(x=710,y=530,width=300,height=100)

        self.lbl_result=Label(self.root,text="Total Result\n[ 0 ]",font=("goudy old style",20),padx=10,pady=10,relief=RIDGE,bg="#038074",fg="white")
  ...
  #=======================================================================  
    def update_details(self):
        ...
        try:
            ...
            cr=cur.fetchall()
            self.lbl_student.config(text=f"Total Studentd\n[{str(len(cr))}]")
    ...
    def logout(self):
        ...
        if op==True:
            self.root.destroy()
            os.system("python loginsystem/login.py")
    ...
    def exit_(self):
        ...
        if op==True:
            self.root.destroy()
            os.system("python loginsystem/register/login.py")
